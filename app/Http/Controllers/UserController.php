...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('user.isi_album', compact('album'));
    }
    //profil
    ...
    public function updatedataprofile(Request $request)
    {
        ...
        ////proses update
         ...
         {
            echo "<script>alert('Berhasil update'); window.location.href='/profile';</script>";
        }
    }
    //fotoprofil
    ...
    //dd($request->current_password);
       if (!Hash::check($request->current_password, $user->password)) {
        ...
        $user->update([
         ...
         {
            echo "<script>alert('Berhasil update'); window.location.href='/password&username';</script>";
        }
    }
